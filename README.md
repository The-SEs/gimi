...
*(Note: If the project was scaffolded with Vite, use `npm run dev` instead).*
...
Since your team is on multiple operating systems, a standard bash script or Makefile might cause headaches for the Windows users. Would you like me to write a short, cross-platform Python script (`run_all.py`) that can spin up both servers at once regardless of the OS?
