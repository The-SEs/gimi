          ...
          <div className="relative w-[420px]">
            ...
            <CardShell>
              <LoginForm
                ...
                error={error} isSubmitting={isSubmitting} isGoogleLoading={isGoogleLoading}
...
interface LoginFormProps {
  ...
  error: string | null; isSubmitting: boolean; isGoogleLoading: boolean;
...
function LoginForm({
  ...
  showPassword, setShowPassword, error,
  isSubmitting, isGoogleLoading, handleSubmit, handleGoogleLogin,
}: LoginFormProps) {
  return (
    <>
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 tracking-tight">Log in</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        <div>
          <input id="email" type="text" autoComplete="email" placeholder="Email or Nickname"
        ...
        <div>
          ...
          <div className="flex justify-end mt-2">
            <Link to="/forgot-password" className="text-sm hover:underline transition" style={{ color: "#2e5fa3" }}>
              Forgot password?
            </Link>
          </div>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        ...
        <Link to="/register" className="font-medium hover:underline transition" style={{ color: "#2889FF" }}>
          Sign up here!
        </Link>
      </p>
    </>
