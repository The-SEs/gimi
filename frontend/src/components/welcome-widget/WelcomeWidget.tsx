...
export default function WelcomeWidget () {
    ...
    const [isBiggerScreen, setIsBiggerScreen] = useState(window.innerWidth >= 1024);
    ...
    return (
        <div className="relative overflow-hidden bg-white p-6 pb-20 mb-10 mt-5 rounded-xl w-[90%] mx-auto lg:w-[55%] lg:pb-35 lg:rounded-3xl xl:w-[65%] xl:pb-35">
            <div className="flex flex-col gap-1">
                <p className="font-varela text-[#1E40AF] lg:text-[18px] lg:text-[#0C1326]">{formattedDate}</p>
                <p className="font-varela font-bold text-2xl text-[#0F172A] lg:text-[48px] lg:text-[#1E3A8A] leading-tight">Hi, Princess!</p>
            ...
            <img src={isBiggerScreen ? lgWelcomeIcon : welcomeIcon} alt=""className={`absolute w-16 h-16 object-contain
