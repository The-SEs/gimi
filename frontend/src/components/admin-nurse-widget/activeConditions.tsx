...
export default function ActiveConditions() {
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-3 sm:p-4 h-full flex flex-col">
      ...
      <div className="flex flex-col gap-2 sm:gap-3 overflow-y-auto">
        ...
        <div className="bg-red-100 border-l-4 border-red-700 rounded-md p-2 sm:p-3">
          <p className="text-xs sm:text-sm tracking-widest text-red-700 mb-1">
            PSYCHOLOGICAL
          </p>
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-red-800 mb-1">
